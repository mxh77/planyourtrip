  ...
  return (
    <div className="h-screen w-screen overflow-hidden relative bg-black">
      ...
      {mapMoved && !searchingArea && (
        <button onClick={handleSearchArea} className="absolute top-[7.5rem] left-1/2 -translate-x-1/2 z-30 bg-white/95 backdrop-blur border border-gray-200 shadow-lg text-sm font-medium text-gray-800 px-4 py-2 rounded-full flex items-center gap-2 hover:bg-white hover:shadow-xl active:scale-95 transition-all">
      ...
      {searchingArea && (
        <div className="absolute top-[7.5rem] left-1/2 -translate-x-1/2 z-30 bg-white/95 backdrop-blur border border-gray-200 shadow-lg text-sm text-gray-500 px-4 py-2 rounded-full flex items-center gap-2">
      ...
      {areaResults && !mapMoved && !searchingArea && (
        <div className="absolute top-[7.5rem] left-1/2 -translate-x-1/2 z-30 bg-white/95 backdrop-blur border border-blue-200 shadow-lg text-xs text-gray-600 px-3 py-1.5 rounded-full flex items-center gap-2">
      ...
      {steps.length > 0 && (
        <div className="absolute bottom-0 left-0 right-0 z-30 pb-4 pt-2 px-2" style={{ paddingBottom: 'calc(1rem + env(safe-area-inset-bottom, 0px))' }}>
          {/* Left arrow */}
          {selectedStepIndex > 0 && (
            <button onClick={() => scrollCarousel(-1)} className="absolute left-3 bottom-[5.5rem] z-40 w-8 h-8 bg-white/90 rounded-full shadow flex items-center justify-center">
          ...
          {selectedStepIndex < steps.length - 1 && (
            <button onClick={() => scrollCarousel(1)} className="absolute right-3 bottom-[5.5rem] z-40 w-8 h-8 bg-white/90 rounded-full shadow flex items-center justify-center">
